...
public class Corsa extends Opel{
    ...
    public static void main(String[] args) {
        ...
        //Object'ler variable'lari buldugu yerden alir gelir.Kendi class'inda varsa parentlara gitmez
        ...
        //object'nin type'i olan class'da ve parentlarda variable bulamazsa CTE verir. Constructor
        // classina gitmez.geri vites yoktur.
        ...
        // arb2.vitesSayisi(); // CTE  (Hicbir parent class'da bulamadigi icin hata verir. constructor class'ina Corsa'ya gitmez)
        ...
        // arb3.garanti(); // CTE
        // arb3.vitesSayisi(); // CTE (Araba class'inda bu method yok baska bakacak parent'ida olmadigi icin hata verir)
    }
}
