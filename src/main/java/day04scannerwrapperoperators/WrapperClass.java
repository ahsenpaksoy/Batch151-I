...
public class WrapperClass {
    public static void main(String[] args) {
        ...
        //Wrapper Class : Character - Boolean - Byte - Short - Integer - Long - Float - Double (primitivlerin wrapper class lari)
        ...
        //"n" yazip "nokta" koyarsaniz hic method goremezsiniz, cunku primive ler method icermez
        int n = 12;
        ...
        //Ornek 1: short data type nin min ve max degerlerini kod yazarak bulun.
        ...
        //atama yaparsak bu isleme autoboxing denir.

        //ii) Wrapper Byte i primitive byte a ceviriniz
        Byte k = 33;
        byte primitiveK = k;
        //wrapper bir kutu icinde bazi methodlarla birlikte bulunan degeri alarak primitive yani
        // method bulunmayan bir kutuya atama yaparsak bu isleme unboxing denir.
