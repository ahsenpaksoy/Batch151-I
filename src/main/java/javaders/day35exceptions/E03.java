...
public class E03 {
  ...
  //Eger catch bloklardaki exception'lar arasinda parent child iliskisi varsa
  // child yukarida parent asagida olmalidir.
  // parent child iliskisi yoksa siranin bir onemi yok
