...
public enum UsStatesEnum {
    //Enum'lar degisme ihtimali olmayan data'lari depolar.
    //Enum icindeki degismeyen sabit data isimleri buyuk harfle yazilir.
    ...
    private final String stateName;  //parantez icindeki datalar icin variable'lar yazdik
                                     //parantez icinde kac tane detay varsa o kadar variable uretilir.
    ...
    public static String getStateNameByUsingAbbreviation(String abbreviation){ //enum'in ismiyle ulasacagimiz icin static oldu
    ...
    public static String getAbbreviationForStateName(String stateName) {
        ...
        //Bu method'lari static yaptik cunku enum'in ismiyle ulasiyoruz, enum'dan object olusturmadik.
    }
}

//application'lar stand alone olmali kendi basina ayakta durabilmeli.
