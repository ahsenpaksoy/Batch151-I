...
public class ArrayList01 {
    ...
    public static void main(String[] args) {
        ...
        //1.Way:
        ages.add(12);  //object'le ulasilan elemanlar non-static'tir
        ages.add(24);
        ages.add(9); //add() method'u elemanlari "giris sirasi"na(insertion order) gore List'e yerlestirir.
        ...
        ages.set(6,111);  //set() method'u eleman degistirmek icin kullanilir.
        System.out.println(ages); //[12, 99, 24, 23, 33, 9, 111, 33]

        //ArrayList'te specific bir elemanin var olup olmadigini nasil anlariz?
        boolean r1 = ages.contains(99); //Array list te specific bir elemanin var olup olmadigini bulmaya yarar.
