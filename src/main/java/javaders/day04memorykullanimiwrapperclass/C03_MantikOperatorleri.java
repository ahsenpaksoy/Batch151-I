...
public class C03_MantikOperatorleri {
    public static void main(String[] args) {
        ...
        1< 4 <5  ==> Java uclu karsilastirma yapmaz
        ...
        Tek & operatoru tum kodu tarar tek bir False varsa False dondurur ama bunun icin tum kodun bitmesini bekler.
        Bu nedenle cift && operatorune gore daha yavas calisir. 
        (3<5 & 3<9 & 11<2 & 4<8 & 2<3)
        ...
        || ==> veya operatoru Polyannaci yapidadir. En ufak bir pozitif durumda True dondurur.
